...
proc ::cafe::mmpbsa_3ways::print_usage { } {
    ...
    show -info "  -rec_top <free receptor topology filename>"
    show -info "  -rec_trj <free receptor trajectory filename>"
    show -info "  -rec <receptor selection>"
    ...
    show -info "  -rec_first <first free receptor frame> -- default: 0"
    show -info "  -rec_last <last free receptor frame>   -- default: -1"
    show -info "  -rec_stride <free receptor stride>     -- default: 1"
    show -info "  -rec_top_type <free receptor topology filetype>    -- default: auto"
    show -info "  -rec_trj_type <free receptor trajectory filetype> -- default: auto"
...
proc ::cafe::mmpbsa_3ways::mmpbsa { args } {
    ...
    if { $sa } {
        ...
        eval assign_radii $ar_args
        # assign SA radii to independent free receptor
        set rec_ar_args "$recmol $sa_rad"
        ...
        eval assign_radii $rec_ar_args
        # assign SA radii to independent free ligand
        set lig_ar_args "$ligmol $sa_rad"
        ...
        if { $recsel ne "" } {
            set rec_sa_list [calc_sa $recmol rec $recsel $recfirst $recstride]
        }
